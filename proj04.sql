...
CREATE TABLE `st_owner` (
  ...
  `insuranceAmount` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `st_owner` VALUES (1,'Rohit Mehra','1988-03-22','MH14XY1234',8700),(2,'Anjali Verma','1993-06-11','UP16JK5678',9400),(3,'Suresh Raina','1980-12-29','RJ18LM9012',10500),(4,'Kavita Joshi','1997-01-15','PB20NO3456',7200),(5,'Manoj Desai','1985-08-27','KL22PQ7890',9900);
...
INSERT INTO `st_patient` VALUES (1,'Asha Reddy','2025-06-01',9876543210,'Malaria'),(2,'Ramesh Gupta','2025-06-10',9123456789,'Diabetes'),(3,'Priya Singh','2025-06-15',9988776655,'Cancer'),(4,'Sunil Kumar','2025-06-18',9090909090,'Malaria'),(5,'Meena Joshi','2025-06-20',9012345678,'Cancer'),(6,'Raju Sharma','2025-06-18',9988776655,'Diabetes'),(7,'Ram Bhataniya','2025-06-18',9090909090,'Malaria'),(8,'Priyanshu chopra','2025-06-27',9988776655,'Diabetes'),(9,'Shyam Bhataniya','2025-06-16',9876543210,'Cancer'),(10,'Yogesh sen','2025-06-22',9012345678,'Diabetes'),(11,'Hritesh Sharma','2025-06-27',9090909090,'Malaria'),(12,'Niraj Chopra','2025-06-26',9876543210,'Malaria'),(13,'Naman Chopra','2025-06-18',9876543210,'Diabetes'),(14,'Prince Bharti','2025-06-10',9012345678,'Diabetes'),(15,'Aryan Shriwastav','2025-06-12',9876543210,'Malaria'),(16,'Aryan','2025-07-24',9988776655,'Malaria'),(17,'Niraj pandey','2025-07-09',9876543210,'Diabetes'),(18,'Ritesh dogaya','2025-07-01',9123456789,'Cancer'),(19,'Shivam Birla','2025-07-23',9988776655,'Diabetes'),(20,'Vijay Patel','2025-07-01',9090909090,'Diabetes');
...
--
-- Dumping data for table `st_route`
--

LOCK TABLES `st_route` WRITE;
/*!40000 ALTER TABLE `st_route` DISABLE KEYS */;
INSERT INTO `st_route` VALUES (1,'Route A','2025-05-19',60,'VH1234'),(2,'Route A','2025-05-19',60,'VH1234'),(3,'Route B','2025-06-01',50,'VH5678'),(4,'Route C','2025-07-10',70,'VH9012');
/*!40000 ALTER TABLE `st_route` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `staffmember` (
  `identify_id` int NOT NULL,
  `fullName` varchar(100) DEFAULT NULL,
  `joiningDate` date DEFAULT NULL,
  `Division` varchar(100) DEFAULT NULL,
  `previousEmployer` varchar(100) DEFAULT NULL,
...
INSERT INTO `staffmember` VALUES (1,'Niraj chopra','2024-12-25','Engineering','Tech Corp'),(2,'Priyanshu Chopra','2025-01-05','Engineering','Tech Corp'),(3,'Shyam Bhataniya','2025-01-06','Mech. Engineering','Tech Corp'),(5,'Ritika Singh','2025-03-01','Marketing','XYZ Inc.'),(6,'Suresh Patel','2025-01-20','Sales','LMN Pvt Ltd'),(7,'Simran Arora','2025-04-10','Engineering','Tech Solutions'),(8,'Manoj Yadav','2025-05-05','Mech. Engineering','Innovative Tech'),(9,'Kavita Sharma','2025-06-01','Marketing','Global Enterprises'),(10,'Rajesh Gupta','2025-07-22','Finance','Capital Solutions');
...
-- Dump completed on 2025-08-02 12:31:55
